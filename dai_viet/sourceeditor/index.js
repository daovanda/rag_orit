...
window.onload = function () {
	...
	var uiLayout = window.DaiVietUI && DaiVietUI.layoutForViewport ? DaiVietUI.layoutForViewport() : { topbar: 35, sidebar: 118 };
	...
	w2utils.locale(n$.locale).then(function (evt) {
		...
		(w2ui["layMain"] || new w2layout({
			...
			panels: [
				{ type: 'top', size: uiLayout.topbar, html: '<div id="divTop" class="nut-full"><img id="imgLogo " height="24" src="favicon.ico"/><i class="nut-link"> Source Editor 1.0</i></div>' },
