				...
				NUT.w2popup.open({
					...
					actions: {
						"_Cancel": function () {
							...
							NUT.ds.get({url:URL_PROXY+"https://set.evnhanoi.vn/rest/proxy?http://10.2.60.1:8080/cp4/dbserver/LdQuery.php?format=default&s="+txtThoiDiem+"&e="+txtThoiDiem2.value+"&ll=20.510958&ul=21.459775&lg=105.163522&ug=106.078134&nocloud=checked"},function(res){
								if(res.success){
									var data=[];
