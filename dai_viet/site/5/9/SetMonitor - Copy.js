var SetMonitor = {
	...
	run: function (p) {
		...
		a.div.innerHTML = "<div id='divMonTabs'></div><div id='divMonitor' class='nut-full'><table border='1' width='100%' height='90%' style='table-layout: fixed'><caption id='cap'><span style='float:left'><input type='checkbox' checked class='w2ui-input' id='chkBd' onchange='SetMonitor.lyr.visible=this.checked'/><label for='chkBd'>Bản đồ</label></span><label for='cboThoiDiem' id='labThoiDiem'>Lúc </label><select id='cboThoiDiem' class='w2ui-input' onchange='SetMonitor.cboThoiDiem_onChange()'></select><span style='float:right'><input type='checkbox' checked class='w2ui-input' id='chkHn' onchange='SetMonitor.pullSetData()'/><label for='chkHn'>Hà Nội</label></span></caption><tr><td><div id='tongcuset' align='center'>Tổng số cú sét... <img src='img/wait.gif'/></div><div id='setnguyhiem' align='center'></div></td><td rowspan='3' id='top20'>20 cú sét gần nhất... <img src='img/wait.gif'/></td></tr><tr><td><div id='xuhuongset'>Xu hướng số cú sét... <img src='img/wait.gif'/></div></td></tr><tr><td><div id='thongkeset'>&nbsp;Thống kê... <img src='img/wait.gif'/></div></td></tr></table></div><div id='divDuLieu' class='nut-full'><div id='divFindSet'><table style='margin:auto'><tr><td align='right'>Dạng sét&nbsp;</td><td><select id='cboDangSet' class='w2ui-input'><option value=''></option><option value='CG'>Sét xuống đất</option><option value='CP'>Sét trong mây</option></select></td><td>&nbsp;</td><td align='right'><input type='checkbox' id='chkNguyHiem' class='w2ui-input'/></td><td>Nguy hiểm&nbsp;</td></tr><tr><td>&nbsp;</td></tr><tr><td align='right'>Cường độ&nbsp;</td><td><input placeholder='=' class='w2ui-input' id='txtCuongDo'/></td><td>&nbsp;</td><td colspan='2'><button class='w2ui-btn' onclick='SetMonitor.timDuLieuSet()'>Search %</button></td></tr></table></div><div id='divDataSet' class='nut-full'></div></div>";
	...
	showDashboard:function () {
		...
		lyr.queryFeatureCount({where:lyr.definitionExpression+" AND DANGSET='CG'"}).then(function (res) {
			tk.push("<img width='20' src='site/5/9/CG20.png'/>Sét xuống đất: " + res + " cú");
			total+=res;
			lyr.queryFeatureCount({where:lyr.definitionExpression+" AND DANGSET='CP'"}).then(function (res2) {
				tk.push("<img width='20' src='site/5/9/CP20.png'/>Sét trên mây: " + res2 + " cú");
