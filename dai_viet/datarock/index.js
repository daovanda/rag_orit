...
window.onload = function () {
	...
	w2utils.locale(n$.locale).then(function (evt) {
		...
		(w2ui["layMain"] || new w2layout({
			...
			panels: [
				{ type: 'top', size: uiLayout.topbar, html: '<i class="nut-link"><img id="imgLogo " width="20" height="20" src="favicon.ico"/> DataRock 1.0</i>' },
				{ type: 'left', size: uiLayout.sidebar, resizable: true, html: '<div id="divLeft" class="nut-full"></div>' },
